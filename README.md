# Lab 2: Identifying ML Problems & Methodology Diagram

## 1. Dataset Description
- **Dataset Name:** Iris Dataset
- **Source:** Open-Source (Seaborn repository / UCI Machine Learning Repository)
- **Format:** Tabular CSV
...
![Methodology Diagram](./Methodology_digram.pingJPG.jpeg)
## 4. Repository Files
- `ml_lab2_noura_2250030204.ipynb`: Google Colab Notebook containing dataset loading, shape inspection, and preview.
- `Methodology_digram.ping.JPG`: Visual workflow of the Machine Learning methodology.
